...
export default function LoadingModal() {
  ...
  return (
    <>
      {isModalOpen && (
        <div className="fixed text-dark-0 inset-0 h-fit my-auto bg-blue-custom z-50 rounded-2xl mx-auto w-10/12 sm:max-w-[450px] shadow-xl">
          <div className="p-10">
            <div className=" flex justify-center items-center" role="status">
              <svg
                aria-hidden="true"
                className="w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-red-custom"
                viewBox="0 0 100 101"
                fill="none"
